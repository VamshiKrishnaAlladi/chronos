...
import './App.css'
import type { ToolKind, ToolFace } from './types'
import { TOOL_LABELS } from './types'
import { formatDuration } from './lib/time'
import { loadStoredPreferences, saveStoredPreferences, DEFAULT_POMODORO_SESSIONS } from './lib/preferences'
...
function App() {
  ...
  // --- Preferences persistence (debounced via saveStoredPreferences) ---
